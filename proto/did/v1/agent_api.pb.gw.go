...
func RegisterAgentAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AgentAPIServer) error {
	...
	mux.Handle("GET", pattern_AgentAPI_Query_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_AgentAPI_Query_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_AgentAPI_AccountInformation_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_AgentAPI_AccountInformation_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("GET", pattern_AgentAPI_TxParameters_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_AgentAPI_TxParameters_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	...
	mux.Handle("POST", pattern_AgentAPI_TxSubmit_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		forward_AgentAPI_TxSubmit_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_AgentAPI_Query_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 1, 0, 4, 1, 5, 3}, []string{"v1", "retrieve", "method", "subject"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AgentAPI_AccountInformation_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "algo", "accountInformation"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AgentAPI_TxParameters_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "algo", "tx", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AgentAPI_TxSubmit_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"v1", "algo", "tx", "submit"}, "", runtime.AssumeColonVerbOpt(true)))
)
